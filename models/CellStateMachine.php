...
class CellStateMachine extends StateMachine
{
    ...
    public function apply($transition, $soft = false)
    {
        ...
        $event = new TransitionEvent($transition, $this->getState(),
            $this->config['transitions'][$transition], $this);
        ...
        $stateKey= array_search($this->getState(),
